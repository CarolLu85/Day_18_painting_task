colors_list =[
(202, 164, 110), (236, 239, 243), (149, 75, 50), (222, 201, 136), (53, 93, 123), (170, 154, 41),
...
# some tuples are deleted as they might be just background colors. to find it out paste the value of rgb into https://www.w3schools.com/colors/colors_rgb.asp to see if it is background color. (remember rbg(x,x,x)